...
from nxtp.src.decoding import GreedyDecoder, BeamSearchDecoder, OneShotDecoder

from nxtp.src.train import load_llama, load_clip
from nxtp.src.loader import build_preprocess
from nxtp.src.models.classifier import LangClassifier
from nxtp.src.utils import load_checkpoint
from nxtp.src.utils import load_config, set_dtype

def main():
    # put all the settings here
    cfg = load_config(["--config", "nxtp/src/configs/config_g3m.py"])
    args = cfg.args
    cfg = set_dtype(args)
